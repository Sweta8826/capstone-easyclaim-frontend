...
export class ApiService {
  ...
  baseUrlUser: string = 'http://34.69.117.154:8080/users/';
  baseUrlClaim: string = 'http://34.69.117.154:8080/claims/';

  login(loginPayload) : Observable<ApiResponse> {
    return this.http.post<ApiResponse>('http://34.69.117.154:8080/' + 'token/generate-token', loginPayload);
  }
